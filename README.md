...
**Windows 11 x64 · v0.2.2 · 自带 .NET · 作者 [dff652](https://github.com/dff652)**
...
- **当前是初步验证版。** 本机 Windows 11 x64 已完成界面和重复启动阻止检查；19 项核心与存储测试及 4 项 Windows 目录检查通过。战网 2.52.12.17821 的国际服登录已有成功记录，完整“国际服 → 国服 → 国际服”及游戏验收仍待完成。详见 [验证记录](./docs/VALIDATION.md)。
